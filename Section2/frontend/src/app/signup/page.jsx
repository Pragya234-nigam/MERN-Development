...
const SignupSchema = Yup.object().shape({
 ...
 .oneOf([Yup.ref('password'),null],'Password must Match')//oneOf is used to compare the value
 .required('Password confirm is required')
  // confirmPassword:Yup.String().confirmPassword('Invalid Password').required('Required'),
